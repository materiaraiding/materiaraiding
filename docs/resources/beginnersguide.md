...
This works due to server-side snapshots where the game has effectively already "finished" the cast when the GCD has less than approx 0.5s remaining. This window will be ping-independent and may vary from player to player.
