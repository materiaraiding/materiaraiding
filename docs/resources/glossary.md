...
FFXIV players like to reuse the names of mechanics seen in older fights to refer to 'similar' mechanics in newer fights. If you do not know the origin of these terms, they are understandably confusing so hopefully this table clears some of them up.

| **Term**      | **Description** |
|------------------------|-----------------|
| **Enumerations**   | "Enumerations" (enums for short) describe mechanics that require a specific number of players to participate in soaking the damage or effects. Similar to "Stack/Soak" mechanics, but with a predetermined player count involved. The stack marker usually has orbs that indicate the required amount of players. |
| **Chariot**           | "Chariot" is a large AoE circle around the boss - dodge by moving 'out.'<br>Originates from "Iron Chariot" in T9. |
| **Dynamo**            | "Dynamo" is a large donut-shaped AoE that surrounds the boss, with a safe zone in the center - dodge by moving 'in.'<br>Originates from "Lunar Dynamo" in T9. |
| **Defamation**        | "Defamation" is a large circular AoE centered on a specific player, requiring them to be very distant from the party.<br>Originates from A12S. |
| **Protean**           | "Protean" describes cone-shaped AoEs that target several or all players in a raid group that need to be dodged. May originate from the boss or an add.<br>Originates from "Protean Wave" in A3. |
| **Exas**          | "Exas" refer to a mechanic involving delayed, sequential AoEs that move in a specified direction. Typically, only the first explosion is visibly marked, requiring players to anticipate subsequent movements. Circular exas are generally known as Exaflares, but names can vary depending on the shape of the moving AoE (e.g. Exalines, Exasquares)<br>Originates from "Exaflare" in UCoB. |
| **Limit Cut** | "Limit Cut" refers to a mechanic that involves numbered dots or shapes appearing on players' heads, signifying the order they will be hit by a mechanic.<br>Originates from A11S. |
| **Akh Morn** | "Akh Morn" refers to a multi-hit AoE attack (may be a party stack or tankbuster depending on the encounter). Common attack seen in encounters with draconic enemies. |
| **Pyretic / Stillness** | A debuff (generally fire-themed) or castbar that incidates the player must be completely still at the end of the timer to avoid damage / death. May also be in the form an of "Acceleration Bomb" debuff. |
