...
The goal here is to utilize all the arrows to fulfil the candle condition stated at the start of the guide.
...
To resolve this, we use static spread positions _regardless_ of tether. Melee players will all be towards Kefka, at **max melee** (or as far away from Kefka as possible). This will result in the confused player being unable to reach and auto-attack any players because they will be teleported along each pad.
...
**Group 1/A** will incorporate both light party pairs that the **stack** belongs to. (I.e. if H1 and D4 have the stack, then H1/MT and D2/D4 all belong to Group 1)

**Group 2/B** will incorporate the remaining non-stack pairs.
...
Each group will have to soak different sets of towers. Because the last 2 sets of towers _both_ give stacks we have to split up **Group 1's** soaks.

- AAA BBBB A

Where A = Group 1, and B = Group 2

During the forsaken raid-wide the group will position themselves like this to quickly determine what group they belong to:

![](\images\ultimate\dmu-forsakenstart.webp)

As the Dragoon I can immediately see that myself and my partner are **AOE** players, therefore we are Group 2/B.
