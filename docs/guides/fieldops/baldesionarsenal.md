...
These items are **extremely rare, expensive and optional** for only a minor increase in damage (if your job directly benefits with more skill/spell speed). In the **Optical Hat's** case, it is actually outclassed by Elemental +2 headgear or Vermillion chestpieces due to the **Elemental Bonus** attached to both pieces, offering more raw offense and defense.
...
Kirin's and Vermillion chestpieces are available for exchange with the **Nostalgic Fellow** in Kugane using **Cryptic Seals** and **Damascene Cloth**, both obtainable within The Baldesion Arsenal. You may also buy the armor, seals and cloths off the Marketboard or ask your local Field Operation groups for any handouts as they aren't used for much else.

## Raid: The Baldesion Arsenal

### Visual Guide

This visual guide details entry requirements, party and Logos action setup and boss abilities and potential callouts. The guide also features the trash mobs between each boss, trap zones and loot. While this guide **isn't 100% accurate** on boss timelines, it should give any player a general idea of boss mechanics.
...
Players can recieve the **Aetherially Primed** buff for **10 minutes** from this FATE provided they fulfill the following conditions:
...
Finally, at least a couple **DPS players** should have the Logos action **Perception L** to uncover any **traps** littered throughout the raid as well as the **portal** leading to the secret rooms.
...
From here, **Art** will enter a loop of attacks until it'd defeated, adding in a few new attacks to the fray:
...
- **Pitfall** and **Glory Unearthed** - The boss will jump away, creating a proximity AoE where it lands and targeting a player with a large chasing AoE.
...
From here, **Owain** will enter a loop of attacks until it's defeated, adding in a couple new attacks to the fray:
...
- **Hands** - **Two Ivory Palms** will spawn around the arena, **tethering** to a player. These adds will swiftly move towards the player and **freeze** in place if being looked at by its tethered player. They also have a **damage resistance buff** that can be removed by being in close proximity of its tethered player.
...
4. **Ame-no-Sakahoko**, a massive untelegraphed PB-AoE centered on itself as well as a large backflip, landing a considerable distance behind where the boss is facing.

5. **Whirling Zantetsuken**, a massive untelegraphed donut with the only safespot being directly under the hitbox.
...
From here, **Raiden** will enter a loop of attacks until it's defeated, adding in a couple new attacks to the fray:

- **Cloud to Ground** - **Two** waves of **exaflares** that spawn along the outer edges of the arena.
...
- **Levinwhorl**  - A heavy hitting raidwide.
...
2. Log out, the doors will open and allow players outside to pull the mobs in your secret room.
:::
...
**Feint L** is also reccomended as the enemies have innate evasion thanks to their **Wind** aspect.
:::
...
5. **Explosive Impulse** - A proximity AoE targeted on a player. **Absolute Virtue** will reappear at its location.
...
| - | :-: | :-: |
| **Sphere** <br> 🪩 | **Black Hole** - <br> **Six** glowing buttons appear around the arena. Players must be standing on a button to avoid being removed from the raid. Additionally, each button must have at least **one** player on it. | Highest emnity target on each platform |
| **Cube** <br> 🧊 | **Flare Star** - <br> Donut centred on **Proto Ozma** | Line-AoE at the highest emnity target on each platform |
| **Pyramid** <br> ⚠️ | **Execration** - <br> Large line AoE down the platform | Small bleed AoE on a random player at the back half on each platform |
| **Star** <br> ⭐ | **Mourning Star** - <br> PB-AoE centred on **Proto Ozma** | Shared damage AoE on a random player on each platform |
...
3. **Orbs** and **Stacks** - Orbs spawn around the arena and begin travelling clockwise, dealing heavy magic damage if popped and exploding for heavy raidwide damage if not popped. Additionally, a random player on each platform is targeted with a shared damage AoE.
    > **MTs** should avoid the stack entirely, use all their **defensives** and pop any orbs travelling towards their platform.
    >> Everyone else should stack towards the front-right of your platform, as to not clip the MT with a **Magic Vulnerability**.

4. **Holy** - A tiny knockback originating from the boss.

5. **Ozmashade**

6. **Stacks** and **Holy** - A small stack AoE followed by the tiny knockback.
:::
...
3. **Acceleration Bomb** - Players are marked with a debuff that begins counting down. When the debuff expires, you cannot be moving or executing any actions.
    > Failing this mechanic deals **90% max HP damage** to yourself and anyone around you, severely crippling you against any upcoming attacks.
...
4. **Meteor** - **Two** players per platform for a total of **six** players are targeted with a placeable proximity AoE. Each proximity AoE also spawns an **Arsenal Urolith**, a **Lightning** aspected add that players need to kill.
...
3. **Meteor** - **Two** players per platform for a total of **six** players are targeted with a placeable proximity AoE. Each proximity AoE also spawns an **Arsenal Urolith**, a **Lightning** aspected add that players need to kill.
    > - **One** player should place their AoE at the back of the platform.
    > - The **other** player should place their AoE at the **clockwise** button.
...
**Proto Ozma** will continue to shift between forms until **hard enraging** at **10:30**, shifting into Star form and casting a long version of **Shooting Star** that wipes the raid.
